...
module.exports.show = async (req, res, next) => {
   ...
   res.render('metrics/indicadores', { activities, children, parents, reviews, sessions, users, topUserActivities, topUserRewiews, topUserSessions, topReviewsActivity, topSessionsChild })
}